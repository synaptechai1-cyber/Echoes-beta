...
const TABS = [
  ...
  { path: '/create', label: 'Post', icon: '＋', aria: 'Create a new post' },
  { path: '/profile/me', label: 'Profile', icon: '◎', aria: 'Your profile' },
]
        ...
        return (
          <button
            ...
            style={{
              ...
              background: isCreate ? 'var(--blue-soft)' : 'transparent',
              borderTop: isCreate ? '1px solid var(--blue)' : 'none',
            }}
          >
            <span aria-hidden="true">{tab.icon}</span>
            <span style={{ fontSize: 10, fontWeight: 500, letterSpacing: '0.04em' }}>{tab.label}</span>
          </button>
        )
      })}
    </nav>
