...
export const api = {
  ...
  editPost: (id, data) => request(`/posts/${id}`, { method: 'PATCH', body: JSON.stringify(data) }),
  ...
  sendGift: (recipient_username, post_id, amount, message) =>
    request('/gifts', { method: 'POST', body: JSON.stringify({ recipient_username, post_id, amount, message }) }),
  getUserGifts: (username) => request(`/users/${username}/gifts`),
}
